...
To store data about all occurrences of every hashtag seen in the past, we use a modified version of the time-aggregated Hokusai system\footnote{http://arxiv.org/pdf/1210.4891v1.pdf}, which is an extension of the Count-Min sketch.  This data structure, which we refer to as the History, is described in full detail in section \ref{Hokusai}.
